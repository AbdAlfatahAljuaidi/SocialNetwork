    ...
    <div className="min-h-screen bg-gray-50 py-10 px-4">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="bg-white p-8 rounded-2xl shadow">
          ...
          {Profile && Profile.length > 0 ? (
            Profile.map((profile, index) => (
              <div className="md:flex bg-gray-50 rounded-xl shadow-inner items-center"   key={index}>

              <div
              
                className="flex flex-col md:flex-row items-center md:items-start gap-4 md:gap-6  p-4 md:p-6  w-full mb-4"
              >
                <div>
                  {profile.imageUrl ? (
                    <img
                ...
                <div className="space-y-1">
                  ...
                  <FaUserGraduate />
                  <p className="text-gray-600 ml-2 text-center md:text-left">
                ...
                <FaLocationDot />
                <p className="text-gray-500 ml-2 text-center md:text-left">
                    {profile.Address}
                  </p>
                </div>
