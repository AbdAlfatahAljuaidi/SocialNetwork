            ...
            <div>
                ...
                <div className='flex justify-between text-sm mt-5 mr-0 ml-4'>
                    ...
                    <Link to={"/ForgetPassword"}>
                        <span className='text-white hover:underline'>Forgot Password?</span>
                    </Link>
                </div>
                ...
                <div className='text-sm text-center mt-5 mr-0 ml-4'>
                    <p>Don't have an account? <span className='text-white font-semibold hover:underline cursor-pointer' onClick={switchToRegister}>Register</span></p>
                </div>
            </div>
        </div>
    );
