...
routerUser.get("/mostPoints", mostPoints);
routerUser.get("/SharePost/:postId", SharePost);
routerUser.get("/ShowChat/:userName/:friendName", ShowChat);
